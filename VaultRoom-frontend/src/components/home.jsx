...
import { FaLock, FaShieldAlt, FaUserAlt, FaSignOutAlt } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-[#081229] flex flex-col">
      ...
      <header className="bg-[#191d3a] text-white py-4 shadow-md">
        <div className="container mx-auto flex justify-between items-center px-4">
          ...
          <nav className="space-x-4">
            ...
            <button
              onClick={onLogout}
              className="bg-[#ec5990] text-white px-6 py-2 rounded-md hover:bg-[#c64c7a]"
            >
      ...
      <section className="bg-[#081229] py-16">
        <div className="container mx-auto text-center px-4">
          <h2 className="text-4xl font-bold text-white mb-4">Welcome Back to VaultRoom</h2>
          <p className="text-white mb-6 text-lg">
            You're securely logged in! Manage your passwords with confidence and ease.
          </p>
          <div className="space-x-4">
            <Link className="bg-[#0e101c] text-white px-6 py-3 rounded-md shadow-md hover:bg-[#ec5990]" style={{border:"1px solid white"}} to='/dashboard'>Go to Dashboard</Link>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-16 bg-[#081229]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <FaUserAlt className="text-[#ec5990] text-5xl mx-auto mb-4" />
